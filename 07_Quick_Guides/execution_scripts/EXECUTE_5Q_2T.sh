#!/bin/bash
# Hardware Execution Script for 5q-2t Configuration
# Pre-validated - All tests passed
# Date: 2025-10-27

echo "================================================================================"
echo "🚀 AUX-QHE HARDWARE EXECUTION - 5q-2t Configuration"
echo "================================================================================"
echo ""
...
echo ""
echo "Expected runtime: ~15-20 minutes (plus queue wait)"
...
echo ""
echo "Recent interim files:"
ls -lt ibm_noise_results_interim_*.json 2>/dev/null | head -5 || echo "   (No interim files found)"
echo ""
...
echo ""
echo "Command:"
echo "   python ibm_hardware_noise_experiment.py --config 5q-2t --backend ibm_torino --account Gia_AUX_QHE"
echo ""
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "   2. Compare results: python compare_local_vs_hardware.py"
    echo "   3. Run next config: python ibm_hardware_noise_experiment.py --config 4q-3t --backend ibm_torino --account Gia_AUX_QHE"
else
    echo "❌ FAILED"
    echo ""
